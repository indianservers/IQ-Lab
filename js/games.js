...
window.GAMES = [
  ...
  { id:'simon-game',          name:'Simon Game',               icon:'🔴', category:'attention', desc:'Repeat the growing color sequence.', create:createSimon },
  { id:'reaction-time',       name:'Reaction Time Test',       icon:'⏱', category:'speed',     desc:'Click as fast as possible when the screen turns green.', create:createReactionTime },
  { id:'multi-task',          name:'Multi-Task Challenge',     icon:'🎭', category:'attention', desc:'Count shapes while reading words simultaneously.', create:createMultiTask },
  { id:'word-association',    name:'Word Association Speed',   icon:'💬', category:'reading',   desc:'Choose the best category for each stimulus word.', create:createWordAssociation },
  { id:'story-recall',        name:'Story Recall',             icon:'📚', category:'memory',    desc:'Read a short story then answer memory questions.', create:createStoryRecall },
  { id:'symbol-digit',        name:'Symbol Digit Coding',      icon:'🔣', category:'reading',   desc:'Use the key to decode as many symbols as possible.', create:createSymbolDigit },
  { id:'hidden-object',       name:'Hidden Object Challenge',  icon:'🔎', category:'attention', desc:'Find the hidden object among a busy emoji scene.', create:createHiddenObject },
  { id:'direction-memory',    name:'Direction Memory',         icon:'🧭', category:'memory',    desc:'Memorize and repeat the arrow direction sequence.', create:createDirectionMemory },
  { id:'rapid-categ',         name:'Rapid Categorization',     icon:'🗂', category:'reading',   desc:'Categorize words as fast as possible in 45 seconds.', create:createRapidCategorization },
  { id:'sudoku-mini',         name:'Sudoku Mini',              icon:'🔢', category:'logic',     desc:'Fill the 4×4 Sudoku grid with logic.', create:createSudokuMini },
